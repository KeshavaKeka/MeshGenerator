...
public class EnhancedProfilerLogger : MonoBehaviour
{
    ...
    public void ExportToCSV(string fileName = "ProfilerLogs.csv")
    {
        ...
        {
            // Write CSV headers
            writer.WriteLine("Frame,FPS,Total CPU (MB),Reserved CPU (MB),Unused Reserved CPU (MB),Mono Heap (MB),Mono Used (MB),Graphics Memory (MB),GPU Time (ms),Dropped Frames,Elapsed Time (s)");
